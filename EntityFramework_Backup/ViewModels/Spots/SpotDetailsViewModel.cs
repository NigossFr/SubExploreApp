...
namespace SubExplore.ViewModels.Spots
{
    ...
    public partial class SpotDetailsViewModel : ViewModelBase
    {
        ...
        private readonly Dictionary<Guid, SpotMedia> _mediaCache = new();
        ...
        public string SpotIdString
        {
            ...
            set 
            {
                ...
                if (!string.IsNullOrEmpty(value) && Guid.TryParse(value, out Guid spotId))
                {
                    ...
                    if (!_isInitialized && SpotId != Guid.Empty)
                    {
