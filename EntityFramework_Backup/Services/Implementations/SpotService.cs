...
namespace SubExplore.Services.Implementations
{
    ...
    public class SpotService : ISpotService
    {
        ...
        public async Task<Spot?> GetSpotWithFullDetailsAsync(Guid spotId)
        {
            try
            {
                _logger.LogInformation("Loading full details for spot {SpotId}", spotId);
                
                // Use query cache for spot retrieval
                ...
                // Use query cache for media retrieval
                var cacheKey = _queryCacheService.GenerateCacheKey("spot:media", spotId);
                var media = await _queryCacheService.GetOrSetQueryAsync(
                    async () => await _spotMediaRepository.GetBySpotIdAsync(spotId),
                    cacheKey,
                    QueryCacheStrategy.SpotData);
        ...
        public async Task<IEnumerable<Spot>> GetSpotsWithinRadiusAsync(double latitude, double longitude, double radiusKm, SpotValidationStatus? status = null)
        {
            try
            {
                ...
                var filterHash = _queryCacheService.GenerateCacheKey("radius", latitude, longitude, radiusKm, status);
                
                var spotsInRadius = await _queryCacheService.GetCollectionAsync<Spot>(
                    async () =>
                    {
        ...
        public async Task<IEnumerable<Spot>> GetRecommendedSpotsAsync(Guid userId, int limit = 10)
        {
            try
            {
        ...
        public async Task<bool> ValidateSpotSafetyAsync(Guid spotId)
        {
            try
            {
        ...
        public async Task<SpotSafetyReport> GenerateSafetyReportAsync(Guid spotId)
        {
            try
            {
                var spot = await _spotRepository.GetByIdAsync(spotId);
        ...
        public async Task<bool> IsSpotSafeForUserLevelAsync(Guid spotId, DifficultyLevel userLevel)
        {
            try
            {
                var spot = await _spotRepository.GetByIdAsync(spotId);
        ...
        public async Task UpdateSpotSafetyReviewAsync(Guid spotId, string reviewNotes, Guid reviewerId)
        {
            try
            {
                var spot = await _spotRepository.GetByIdAsync(spotId);
        ...
        public async Task RecordSpotVisitAsync(Guid spotId, Guid userId)
        {
            try
            {
        ...
        public async Task<SpotStatistics> GetSpotStatisticsAsync(Guid spotId)
        {
            try
            {
        ...
        public async Task<double> GetSpotAverageRatingAsync(Guid spotId)
        {
            // TODO: Implement rating system
            return 0.0;
        }
        
        public async Task<int> GetSpotReviewCountAsync(Guid spotId)
        {
            // TODO: Implement review system
            return 0;
        }
        
        public async Task<bool> HasUserVisitedSpotAsync(Guid spotId, Guid userId)
        {
        ...
        public async Task<IEnumerable<Spot>> GetSimilarSpotsAsync(Guid spotId, int limit = 5)
        {
            try
            {
        ...
        public async Task<IEnumerable<Spot>> GetSpotsNearUserAsync(Guid userId, double radiusKm = 50)
        {
            try
            {
                var user = await _userRepository.GetByIdAsync(userId);
        ...
        public async Task<bool> ToggleFavoriteSpotAsync(Guid spotId, Guid userId)
        {
            try
            {
        ...
        public async Task<bool> IsSpotFavoriteAsync(Guid spotId, Guid userId)
        {
            try
            {
        ...
        public async Task<IEnumerable<Spot>> GetUserFavoriteSpotsAsync(Guid userId)
        {
            try
            {
        ...
        public async Task<Models.Domain.WeatherInfo?> GetSpotCurrentWeatherAsync(Guid spotId)
        {
            try
            {
        ...
        public async Task<TideInfo?> GetSpotTideInfoAsync(Guid spotId)
        {
        ...
        public async Task<SpotQualityScore> CalculateSpotQualityScoreAsync(Guid spotId)
        {
            try
            {
                var spot = await _spotRepository.GetByIdAsync(spotId);
        ...
        public async Task<bool> RequiresExpertValidationAsync(Guid spotId)
        {
            try
            {
                var spot = await _spotRepository.GetByIdAsync(spotId);
        ...
        public async Task FlagSpotForReviewAsync(Guid spotId, string reason, Guid reporterId)
        {
            try
            {
        ...
        private int CalculateDataCompletenessScore(Spot spot)
        {
            ...
            if (spot.TypeId != Guid.Empty) score++;
        ...
        private async Task<int> CalculateMediaQualityScoreAsync(Guid spotId)
        {
            try
            {
        ...
        private async Task<int> CalculateCommunityEngagementScoreAsync(Guid spotId)
        {
