    ...
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public async Task<bool> RefreshTokenAsync()
        {
            try
            {
                ...
                {
                    var currentUserId = _secureSettings.Get<Guid?>("CurrentUserId");
        ...
        public async Task<bool> ElevateToModeratorAsync(Guid userId, ModeratorSpecialization specialization)
        {
            try
            {
        ...
        public async Task<bool> UpdateModeratorStatusAsync(Guid userId, ModeratorStatus status)
        {
            try
            {
                var user = await _userRepository.GetByIdAsync(userId);
        ...
        public async Task<bool> VerifyProfessionalAccountAsync(Guid userId, Guid? organizationId = null)
        {
            try
            {
                var user = await _userRepository.GetByIdAsync(userId);
        ...
        /// <returns>True if update successful</returns>
        public async Task<bool> UpdateUserPermissionsAsync(Guid userId, UserPermissions permissions)
        {
            try
            {
                var user = await _userRepository.GetByIdAsync(userId);
