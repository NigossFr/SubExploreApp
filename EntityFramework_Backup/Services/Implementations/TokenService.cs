...
namespace SubExplore.Services.Implementations
{
    ...
    public class TokenService : ITokenService
    {
        ...
        public string GenerateAccessToken(Guid userId, string email, IEnumerable<Claim>? claims = null)
        {
            try
            {
        ...
        /// </summary>
        public async Task RevokeAllUserTokensAsync(Guid userId, string reason = RevocationReasons.PasswordChanged)
        {
            try
            {
