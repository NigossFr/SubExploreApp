...
namespace SubExplore.Repositories.Implementations
{
    ...
    public class PasswordResetTokenRepository : GenericRepository<PasswordResetToken>, IPasswordResetTokenRepository
    {
        ...
        public async Task<List<PasswordResetToken>> GetValidTokensForUserAsync(Guid userId)
        {
            return await _context.PasswordResetTokens
        ...
        public async Task<bool> HasReachedDailyLimitAsync(Guid userId, int maxResetsPerDay = 5)
        {
