...
namespace SubExplore.Repositories.Implementations
{
    ...
    public class GenericRepository<T> : IGenericRepository<T> where T : class
    {
        ...
        /// <summary>
        /// Get all entities with optimized query execution (use with caution for large datasets)
        /// </summary>
        /// <param name="cancellationToken">Cancellation token</param>
        ...
        public virtual async Task<IEnumerable<T>> GetAllAsync(CancellationToken cancellationToken = default)
        {
            return await _dbSet
                .AsNoTracking()
                .AsSplitQuery() // Optimize for complex queries
                .ToListAsync(cancellationToken)
                .ConfigureAwait(false);
        }

        /// <summary>
        /// Find entities matching the specified predicate with optimized query execution
        /// </summary>
        ...
        /// <summary>
        /// Get entities with paging support for efficient data retrieval with optimized queries
        /// </summary>
