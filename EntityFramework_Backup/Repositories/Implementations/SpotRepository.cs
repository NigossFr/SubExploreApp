...
namespace SubExplore.Repositories.Implementations
{
    public class SpotRepository : GenericRepository<Spot>, ISpotRepository
    {
        ...
        public override async Task<Spot?> GetByIdAsync(Guid id, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<IEnumerable<Spot>> GetSpotsByTypeAsync(Guid typeId)
        {
            try
            {
        ...
        public async Task<IEnumerable<Spot>> GetSpotsByUserAsync(Guid userId)
        {
            try
            {
