...
namespace SubExplore.Repositories.Interfaces
{
    ...
    public interface IRevokedTokenRepository : IGenericRepository<RevokedToken>
    {
        ...
        Task RevokeTokenAsync(string tokenHash, string tokenType, Guid? userId = null, 
        ...
        /// <param name="reason">Reason for revocation</param>
        Task RevokeAllUserTokensAsync(Guid userId, string reason = RevocationReasons.UserLogout);
        ...
        Task<List<RevokedToken>> GetUserRevokedTokensAsync(Guid userId, int limit = 50);
    }
}