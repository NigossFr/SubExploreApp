...
namespace SubExplore.Repositories.Interfaces
{
    ...
    public interface IUserFavoriteSpotRepository : IGenericRepository<UserFavoriteSpot>
    {
        ...
        Task<IEnumerable<UserFavoriteSpot>> GetUserFavoritesAsync(Guid userId, CancellationToken cancellationToken = default);
        ...
        Task<UserFavoriteSpot?> GetUserFavoriteAsync(Guid userId, Guid spotId, CancellationToken cancellationToken = default);
        ...
        Task<IEnumerable<User>> GetSpotFavoritersAsync(Guid spotId, CancellationToken cancellationToken = default);
        ...
        Task<IEnumerable<UserFavoriteSpot>> GetUserNotificationFavoritesAsync(Guid userId, CancellationToken cancellationToken = default);
        ...
        Task<bool> RemoveFavoriteAsync(Guid userId, Guid spotId, CancellationToken cancellationToken = default);
