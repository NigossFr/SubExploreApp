    ...
    public partial class SpotDiagnosticViewModel : ViewModelBase
    {
        ...
        private async Task ForceMigration()
        {
            try
            {
                ...
                // Force migration - PostgreSQL compatible
                // await Helpers.SpotValidationMigrationHelper.ApplySpotValidationMigrationAsync(); // MySQL helper disabled
                _logger.LogInformation("PostgreSQL migration helper not yet implemented");
