...
namespace SubExplore.Services.Interfaces
{
    ...
    public interface IFavoriteSpotService
    {
        ...
        Task<bool> AddToFavoritesAsync(Guid userId, Guid spotId, int priority = 5, string? notes = null, bool notificationEnabled = true, CancellationToken cancellationToken = default);
        ...
        Task<bool> RemoveFromFavoritesAsync(Guid userId, Guid spotId, CancellationToken cancellationToken = default);
        ...
        Task<bool> ToggleFavoriteAsync(Guid userId, Guid spotId, CancellationToken cancellationToken = default);
        ...
        Task<bool> IsSpotFavoritedAsync(Guid userId, Guid spotId, CancellationToken cancellationToken = default);
        ...
        Task<IEnumerable<UserFavoriteSpot>> GetUserFavoritesAsync(Guid userId, int pageNumber = 1, int pageSize = 20, CancellationToken cancellationToken = default);
        ...
        Task<IEnumerable<UserFavoriteSpot>> GetUserFavoritesByPriorityAsync(Guid userId, CancellationToken cancellationToken = default);
        ...
        Task<bool> UpdateFavoritePriorityAsync(Guid userId, Guid spotId, int priority, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation token</param>
        /// <returns>True if updated successfully</returns>
        Task<bool> UpdateFavoriteNotesAsync(Guid userId, Guid spotId, string? notes, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation token</param>
        /// <returns>True if updated successfully</returns>
        Task<bool> UpdateFavoriteNotificationAsync(Guid userId, Guid spotId, bool enabled, CancellationToken cancellationToken = default);
        ...
        Task<IEnumerable<UserFavoriteSpot>> GetNotificationFavoritesAsync(Guid userId, CancellationToken cancellationToken = default);
        ...
        Task<FavoriteSpotStats> GetUserFavoriteStatsAsync(Guid userId, CancellationToken cancellationToken = default);
        ...
        Task<int> GetSpotFavoritesCountAsync(Guid spotId, CancellationToken cancellationToken = default);
    }
