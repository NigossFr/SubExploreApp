...
{
    public partial class SpotTypeSelectionPage : ContentPage
    {
        private readonly SpotTypeSelectionViewModel _viewModel;
        private readonly ILogger<SpotTypeSelectionPage> _logger;

        public SpotTypeSelectionPage(SpotTypeSelectionViewModel viewModel, ILogger<SpotTypeSelectionPage> logger)
        {
            InitializeComponent();
        ...
        {
            base.OnAppearing();
            _logger.LogDebug("SpotTypeSelectionPage OnAppearing called");
            ...
            {
                _logger.LogError(ex, "ERROR: SpotTypeSelectionPage OnAppearing failed");
            }
        }
    }
}