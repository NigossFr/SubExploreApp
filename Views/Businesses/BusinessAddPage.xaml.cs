...
{
    public partial class BusinessAddPage : ContentPage
    {
        private readonly BusinessAddViewModel _viewModel;
        private readonly ILogger<BusinessAddPage> _logger;

        public BusinessAddPage(BusinessAddViewModel viewModel, ILogger<BusinessAddPage> logger)
        {
            InitializeComponent();
        ...
        {
            base.OnAppearing();
            _logger.LogDebug("BusinessAddPage OnAppearing called");
            ...
            {
                _logger.LogError(ex, "ERROR: BusinessAddPage OnAppearing failed");
            }
        }
    }
}